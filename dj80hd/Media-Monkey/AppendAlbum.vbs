' !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
' This script allows you to append a string to the album
...
'
' [AppendAlbum]
' FileName=AppendAlbum.vbs
' ProcName=AppendAlbum
' Order=11
' DisplayName=Append Album Name
' Description=Append Album Name
' Language=VBScript
' ScriptType=0
'
...
Sub AppendAlbum
  ...
  Lbl.AutoSize = False
  Lbl.Multiline = True
  Lbl.Caption = SDB.LocalizedFormat( "This will modify the album name of %d selected tracks. Do you want to proceed?", list.Count, 0, 0)     ' TODO:  Localize

  Set Lbl = UI.NewLabel( Form)
  Lbl.Common.SetRect 10,65,280,20
  Lbl.Caption = SDB.Localize("Append To Album:")
  ...
  if Form.ShowModal=1 then
    ...
    For i=0 To list.count-1
      Set itm = list.Item(i)
      itm.AlbumName = itm.AlbumName + SE.Text
    Next
    list.UpdateAll
  End If
End Sub
