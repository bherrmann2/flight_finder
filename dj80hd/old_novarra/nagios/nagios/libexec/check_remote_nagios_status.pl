...
Options:
 -s, --status=FILE_NAME
   Location and name of status log (e.g. /usr/local/groundwork/nagios/var/status.log)
 -d, --dir=DIRECTORY_NAME
   Directory that contains the nagios logs (e.g. /usr/local/groundwork/nagios/var/)
