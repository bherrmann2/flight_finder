...
# 
#  command[check_sap_ms]=/usr/local/groundwork/nagios/libexec/check_sap ms $HOSTADDRESS$ $ARG1$ $ARG2$ 
#  command[check_sap_as]=/usr/local/groundwork/nagios/libexec/check_sap as $HOSTADDRESS$ $ARG1$ 
#  command[check_sap_ex]=/usr/local/groundwork/nagios/libexec/check_sap as $ARG1$ $ARG2$ 
